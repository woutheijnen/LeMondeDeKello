...
procedure imgET32;
  begin
    ...
    couleurtexte(15);
    write(' APPUYEZ SUR');   couleurtexte(5); write('     |    |/ _|   ____   |  |   |  |   \   _  \');   couleurtexte(15); writeln('     COPYRIGHT');
    couleurtexte(5);
    write('                 |      <   _/ __ \  |  |   |  |   /  /_\  \');   couleurtexte(15); writeln('       2013');
    couleurtexte(15);
    write(' ENTREE POUR');   couleurtexte(5); writeln('     |    |  \  \  ___/  |  |__ |  |__ \  \_/   \');
    write('                 |____|__ \  \___  > |____/ |____/  \_____  /');   couleurtexte(15); writeln('  HEIJNEN Wout');
    couleurtexte(15);
    write(' CONTINUER !');   couleurtexte(5); write('             \/      \/                       \/');   couleurtexte(15); writeln('  GOUVERNET Alan');
