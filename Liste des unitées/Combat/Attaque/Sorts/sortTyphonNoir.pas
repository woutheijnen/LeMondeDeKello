...
//Header
  procedure typhonNoirAdv;
  procedure typhonNoirPers;
...
procedure typhonNoirAdv;
  begin
    ...
    efficaciteAdv := lireIntegerRam(53);
      if (precision = 0) then
        begin
          text3 := 'Pendant que votre adversaire crée un typhon noir, Il se loupe.';
          degatPers2 := 0;
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficaciteAdv = 1 then text3 := 'Votre adversaire lance un typhon noir. Ce n´est pas très effiace.';
          if efficaciteAdv = 2 then text3 := 'Votre adversaire lance un typhon noir.';
          if efficaciteAdv = 4 then text3 := 'Votre adversaire lance un typhon noir. C´est très efficace.';
...
procedure typhonNoirPers;
  begin
    ...
    aleatoire(1,20);
      if (precision = 0) then
        begin
          text1 := 'Pendant que vous essayez de créer un typhon noir, vous vous loupez.';
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficacitePers = 1 then text1 := 'Vous lancez un typhon noir. Ce n´est pas très efficace.';
          if efficacitePers = 2 then text1 := 'Vous lancez un typhon noir.';
          if efficacitePers = 4 then text1 := 'Vous lancez un typhon noir. C´est très efficace.';
          degatPers := 0;
