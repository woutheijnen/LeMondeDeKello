...
//Header
  procedure feuSacreAdv;
  procedure feuSacrePers;
...
procedure feuSacreAdv;
  begin
    ...
    chanceStatut := lireIntegerRam(0);
      ...
      if (precision = 0) then
        begin
          text3 := 'Pendant que votre adversaire lance feu sacré, Il se loupe.';
          degatPers2 := 0;
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficaciteAdv = 1 then text3 := 'Votre adversaire lance feu sacré. Ce n´est pas très effiace.';
          if efficaciteAdv = 2 then text3 := 'Votre adversaire lance feu sacré.';
          if efficaciteAdv = 4 then text3 := 'Votre adversaire lance feu sacré. C´est très efficace.';
...
procedure feuSacrePers;
  begin
    ...
    chanceStatut := lireIntegerRam(0);
      ...
      if (precision = 0) then
        begin
          text1 := 'Pendant que vous essayez de lancer feu sacré, vous vous loupez.';
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficacitePers = 1 then text1 := 'Vous lancez feu sacré. Ce n´est pas très efficace.';
          if efficacitePers = 2 then text1 := 'Vous lancez feu sacré.';
          if efficacitePers = 4 then text1 := 'Vous lancez feu sacré. C´est très efficace.';
          degatPers := 0;
