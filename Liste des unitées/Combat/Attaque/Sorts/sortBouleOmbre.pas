...
procedure bouleOmbreAdv;
  begin
    ...
    chanceStatut := lireIntegerRam(0);
      ...
      if (precision = 0) then
        begin
          text3 := 'Pendant que votre adversaire crée une boule d´ombre, Il se loupe.';
          degatPers2 := 0;
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficaciteAdv = 1 then text3 := 'Votre adversaire lance une boule d´ombre. Ce n´est pas très effiace.';
          if efficaciteAdv = 2 then text3 := 'Votre adversaire lance une boule d´ombre.';
          if efficaciteAdv = 4 then text3 := 'Votre adversaire lance une boule d´ombre. C´est très efficace.';
...
procedure bouleOmbrePers;
  begin
    ...
    chanceStatut := lireIntegerRam(0);
      ...
      if (precision = 0) then
        begin
          text1 := 'Pendant que vous essayez de créer une boule d´ombre, vous vous loupez.';
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficacitePers = 1 then text1 := 'Vous lancez une boule d´ombre. Ce n´est pas très efficace.';
          if efficacitePers = 2 then text1 := 'Vous lancez une boule d´ombre.';
          if efficacitePers = 4 then text1 := 'Vous lancez une boule d´ombre. C´est très efficace.';
          degatPers := 0;
