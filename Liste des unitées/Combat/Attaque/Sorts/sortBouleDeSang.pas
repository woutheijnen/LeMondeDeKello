...
//Header
  procedure bouleDeSangAdv;
  procedure bouleDeSangPers;
...
procedure bouleDeSangAdv;
  begin
    ...
    efficaciteAdv := lireIntegerRam(53);
      if (precision = 0) then
        begin
          text3 := 'Pendant que votre adversaire crée une boule de sang, Il se loupe.';
          degatPers2 := 0;
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficaciteAdv = 1 then text3 := 'Votre adversaire lance une boule de sang. Ce n´est pas très effiace.';
          if efficaciteAdv = 2 then text3 := 'Votre adversaire lance une boule de sang.';
          if efficaciteAdv = 4 then text3 := 'Votre adversaire lance une boule de sang. C´est très efficace.';
...
procedure bouleDeSangPers;
  begin
    ...
    efficacitePers := lireIntegerRam(64);
      if (precision = 0) then
        begin
          text1 := 'Pendant que vous essayez de créer une boule de sang, vous vous loupez.';
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficacitePers = 1 then text1 := 'Vous lancez une boule de sang. Ce n´est pas très efficace.';
          if efficacitePers = 2 then text1 := 'Vous lancez une boule de sang.';
          if efficacitePers = 4 then text1 := 'Vous lancez une boule de sang. C´est très efficace.';
          degatPers := 0;
