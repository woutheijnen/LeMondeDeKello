...
//Header
  procedure aeroblastAdv;
  procedure aeroblastPers;
...
procedure aeroblastAdv;
  begin
    ...
    efficaciteAdv := lireIntegerRam(53);
      if (precision = 0) then
        begin
          text3 := 'Pendant que votre adversaire crée un aéroblast, Il se loupe.';
          degatPers2 := 0;
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficaciteAdv = 1 then text3 := 'Votre adversaire lance un aéroblast. Ce n´est pas très effiace.';
          if efficaciteAdv = 2 then text3 := 'Votre adversaire lance un aéroblast.';
          if efficaciteAdv = 4 then text3 := 'Votre adversaire lance un aéroblast. C´est très efficace.';
...
procedure aeroblastPers;
  begin
    ...
    efficacitePers := lireIntegerRam(64);
      if (precision = 0) then
        begin
          text1 := 'Pendant que vous essayez de créer un aéroblast, vous vous loupez.';
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficacitePers = 1 then text1 := 'Vous lancez un aéroblast. Ce n´est pas très efficace.';
          if efficacitePers = 2 then text1 := 'Vous lancez un aéroblast.';
          if efficacitePers = 4 then text1 := 'Vous lancez un aéroblast. C´est très efficace.';
          degatPers := 0;
