...
//Header
  procedure tenebresAdv;
  procedure tenebresPers;
...
procedure tenebresAdv;
  begin
    ...
    efficaciteAdv := lireIntegerRam(53);
      if (precision = 0) then
        begin
          text3 := 'Pendant que votre adversaire crée des ténèbres, Il se loupe.';
          degatPers2 := 0;
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficaciteAdv = 1 then text3 := 'Votre adversaire lance des ténèbres. Ce n´est pas très effiace.';
          if efficaciteAdv = 2 then text3 := 'Votre adversaire lance des ténèbres.';
          if efficaciteAdv = 4 then text3 := 'Votre adversaire lance des ténèbres. C´est très efficace.';
...
procedure tenebresPers;
  begin
    ...
    efficacitePers := lireIntegerRam(64);
      if (precision = 0) then
        begin
          text1 := 'Pendant que vous essayez de créer des ténèbres, vous vous loupez.';
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficacitePers = 1 then text1 := 'Vous lancez des ténèbres. Ce n´est pas très efficace.';
          if efficacitePers = 2 then text1 := 'Vous lancez des ténèbres.';
          if efficacitePers = 4 then text1 := 'Vous lancez des ténèbres. C´est très efficace.';
          degatPers := 0;
