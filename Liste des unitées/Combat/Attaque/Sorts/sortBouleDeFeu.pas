...
//Header
  procedure bouleDeFeuAdv;
  procedure bouleDeFeuPers;
  ...
  begin
    ...
    chanceStatut := lireIntegerRam(0);
      if (chanceStatut = 1) and (statutPers = '') then
        begin
          text4 := 'La boule de feu vous brûle.';
          statutPers := 'Brulé';
          ecrireStringRam(15, statutPers);
        end;
      if (precision = 0) then
        begin
          text3 := 'Pendant que votre adversaire crée une boule de feu, Il prend feu.';
          degatPers2 := 0;
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficaciteAdv = 1 then text3 := 'Votre adversaire lance une boule de feu. Ce n´est pas très effiace.';
          if efficaciteAdv = 2 then text3 := 'Votre adversaire lance une boule de feu.';
          if efficaciteAdv = 4 then text3 := 'Votre adversaire lance une boule de feu. C´est très efficace.';
  ...
  begin
    ...
    chanceStatut := lireIntegerRam(0);
      if (chanceStatut = 1) and (statutAdv = '') then
        begin
          text2 := 'La boule de feu brûle votre adversaire.';
          statutAdv := 'Brulé';
          ecrireStringRam(14, statutAdv);
        end;
      if (precision = 0) then
        begin
          text1 := 'Pendant que vous essayez de créer un boule de feu, vous prenez feu.';
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficacitePers = 1 then text1 := 'Vous lancez une boule de feu. Ce n´est pas très efficace.';
          if efficacitePers = 2 then text1 := 'Vous lancez une boule de feu.';
          if efficacitePers = 4 then text1 := 'Vous lancez une boule de feu. C´est très efficace.';
          degatPers := 0;
