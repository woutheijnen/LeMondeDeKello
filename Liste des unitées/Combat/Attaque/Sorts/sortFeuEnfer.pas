  ...
  begin
    ...
    chanceStatut := lireIntegerRam(0);
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficaciteAdv = 1 then text3 := 'Votre adversaire lance feu d´enfer. Ce n´est pas très effiace.';
          if efficaciteAdv = 2 then text3 := 'Votre adversaire lance feu d´enfer.';
          if efficaciteAdv = 4 then text3 := 'Votre adversaire lance feu d´enfer. C´est très efficace.';
...
procedure feuEnferPers;
  begin
    ...
    chanceStatut := lireIntegerRam(0);
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficacitePers = 1 then text1 := 'Vous lancez feu d´enfer. Ce n´est pas très efficace.';
          if efficacitePers = 2 then text1 := 'Vous lancez feu d´enfer.';
          if efficacitePers = 4 then text1 := 'Vous lancez feu d´enfer. C´est très efficace.';
          degatPers := 0;
