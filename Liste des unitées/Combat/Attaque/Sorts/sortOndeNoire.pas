...
//Header
  procedure ondeNoireAdv;
  procedure ondeNoirePers;
...
procedure ondeNoireAdv;
  begin
    ...
    aleatoire(1,20);
      if (precision = 0) then
        begin
          text3 := 'Pendant que votre adversaire crée un onde noire, Il se loupe.';
          degatPers2 := 0;
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficaciteAdv = 1 then text3 := 'Votre adversaire lance un onde noire. Ce n´est pas très effiace.';
          if efficaciteAdv = 2 then text3 := 'Votre adversaire lance un onde noire.';
          if efficaciteAdv = 4 then text3 := 'Votre adversaire lance un onde noire. C´est très efficace.';
...
procedure ondeNoirePers;
  begin
    ...
    efficacitePers := lireIntegerRam(64);
      if (precision = 0) then
        begin
          text1 := 'Pendant que vous essayez de créer un onde noire, vous vous loupez.';
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficacitePers = 1 then text1 := 'Vous lancez un onde noire. Ce n´est pas très efficace.';
          if efficacitePers = 2 then text1 := 'Vous lancez un onde noire.';
          if efficacitePers = 4 then text1 := 'Vous lancez un onde noire. C´est très efficace.';
          degatPers := 0;
