...
//Header
  procedure chuteNoireAdv;
  procedure chuteNoirePers;
...
procedure chuteNoireAdv;
  begin
    ...
    efficaciteAdv := lireIntegerRam(53);
      if (precision = 0) then
        begin
          text3 := 'Pendant que votre adversaire lance chute noire, Il se loupe.';
          degatPers2 := 0;
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficaciteAdv = 1 then text3 := 'Votre adversaire lance chute noire. Ce n´est pas très effiace.';
          if efficaciteAdv = 2 then text3 := 'Votre adversaire lance chute noire.';
          if efficaciteAdv = 4 then text3 := 'Votre adversaire lance chute noire. C´est très efficace.';
...
procedure chuteNoirePers;
  begin
    ...
    aleatoire(1,20);
      if (precision = 0) then
        begin
          text1 := 'Pendant que vous essayez de lancer chute noire, vous vous loupez.';
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficacitePers = 1 then text1 := 'Vous lancez chute noire. Ce n´est pas très efficace.';
          if efficacitePers = 2 then text1 := 'Vous lancez chute noire.';
          if efficacitePers = 4 then text1 := 'Vous lancez chute noire. C´est très efficace.';
          degatPers := 0;
