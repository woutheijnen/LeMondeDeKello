...
//Header
  procedure hydroblastAdv;
  procedure hydroblastPers;
...
procedure hydroblastAdv;
  begin
    ...
    efficaciteAdv := lireIntegerRam(53);
      if (precision = 0) then
        begin
          text3 := 'Pendant que votre adversaire lance hydroblast, Il se loupe.';
          degatPers2 := 0;
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficaciteAdv = 1 then text3 := 'Votre adversaire lance hydroblast sur vous. Ce n´est pas très effiace.';
          if efficaciteAdv = 2 then text3 := 'Votre adversaire lance hydroblast sur vous.';
          if efficaciteAdv = 4 then text3 := 'Votre adversaire lance hydroblast sur vous. C´est très efficace.';
...
procedure hydroblastPers;
  begin
    ...
    efficacitePers := lireIntegerRam(64);
      if (precision = 0) then
        begin
          text1 := 'Pendant que vous essayez de lancer hydroblast, vous vous loupez.';
      ...
      if (precision > 1) and (precision <= 90) then
        begin
          if efficacitePers = 1 then text1 := 'Vous lancez hydroblast. Ce n´est pas très efficace.';
          if efficacitePers = 2 then text1 := 'Vous lancez hydroblastd.';
          if efficacitePers = 4 then text1 := 'Vous lancez hydroblast. C´est très efficace.';
          degatPers := 0;
